...
public class CurrentAdminsSceneController implements Initializable {
    ...
    public ObservableList<UserData> getUsers() throws IOException{
        ...
        ObservableList<UserData> admins = FXCollections.observableArrayList();

        String fileName = "src/Booking/Admins.txt";
        File file = new File(fileName);
        List<String> lines =  Files.readAllLines(Paths.get("src/Booking/Admins.txt"), Charset.defaultCharset());
        ...
        while (inputStream.hasNext()){
            ...
            admins.add(new UserData(singleValues[0], singleValues[1], singleValues[2]));
